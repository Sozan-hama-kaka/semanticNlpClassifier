...
{{--                    @csrf--}}
{{--                    <div class="mb-3">--}}
{{--                        <textarea name="summary" required class="form-control" id="summary" rows="10" placeholder="Document Abstract"></textarea>--}}
{{--                    </div>--}}
{{--                    <div class="mb-3">--}}
...
{{--                        <p>{{ json_encode($result) }}</p> <!-- Adjust this to format the result as needed -->--}}
{{--                    </div>--}}
{{--                @endif--}}
